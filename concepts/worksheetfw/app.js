...
*/
		...
		var closeButtonElement = function(idDialog)
		{
			return tools.styledButton(idDialog + "Close", "&times;", function(){onCloseDialog(idDialog); return false;}, true, "closeButton");
		}
...
/*        var closeButtonEnabledHtml = function(idDialog)
        ...
        var mainMenuElement = function()
        {
					...
					menuItems.push(
							tools.createElement(
								...
								[ tools.createElement(
									"a",
									{
										innerHTML: TR(module.description),
										href: "#",
										onclick: function(){app.gotoModule(module.name); return false;}
									}
									)
								]
								)
			...
			return tools.createElement("div", { id: "idMainMenu" }, menuItems);
		}

        var settingsDialogElement = function()
        {
			var settingsContents = undefined;
			var settingsDialog = tools.createElement("div", "idSettings", "topLevelDiv");
			settingsDialog.appendChild(closeButtonElement("idSettings"));

			settingsContents = tools.createElement("span", "idSettingsContents");
			module.settingsDialogElements(settingsContents);
			settingsContents.appendChild(tools.styledButton("idStart", TR("Start"), function(){onSettingsStart();}, true));
			
			settingsDialog.appendChild(settingsContents);
...
*/
        ...
        var worksheetHtml = function()
        {
            ...
            {
              s += "<div class=\"worksheetRow\" id=\"idWorksheetRow" + tools.indexToString(row) + "\" onclick=\"app.onRowClicked(" + row + ")\">";
...
//            tools.setElement(tools.body(), mainMenuHtml());
            tools.body().appendChild(mainMenuElement());
            return true;
        };
...
//            tools.setElement(tools.body(), settingsDialogHtml());
            tools.deleteChildren(tools.body());
            tools.body().appendChild(settingsDialogElement());
            return true;
        };
