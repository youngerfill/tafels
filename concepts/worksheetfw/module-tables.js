...
function create_module(common)
{
	...
	var settingsDialogElements = function(settingsContents)
	{
		var tablePicker = undefined;
		var i=0;

		settingsContents.appendChild(tools.createElement("div", undefined, TR("Choose the tables you want to practise:")));

		tablePicker = tools.createElement("div", undefined, undefined, TR("The table of:") + " ");
        for (i=1; i<=10; i++)
        {
            id = "idTable" + tools.indexToString(i);
            s += "<input type=\"checkbox\" onclick=\"module.onTableChecked()\" id=\"" + id + "\"/><label for=\"" + id + "\">" + i + "</label>";
...
//        tools.log("Charcode = " + charCode);
    ...
    return {
      ...
      settingsDialogElements : settingsDialogElements,
